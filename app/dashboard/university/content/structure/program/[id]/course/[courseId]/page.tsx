...
export default function CourseDetail({ params }: { params: { id: string, courseId: string } }) {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="mb-6">
        <Link 
          href={`/dashboard/university/content/structure/program/${params.id}`} 
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-6 mb-8">
        ...
        <div className="border-t border-gray-200 pt-6">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-xl font-semibold text-gray-900">Lessons ({course.lessons_count})</h2>
            <button 
                    ...
                    <tr key={lesson.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div className="flex space-x-2">
                          ...
                          <Link 
                            href={`/dashboard/university/content/structure/program/${params.id}/course/${course.id}/lesson/${lesson.id}`}
