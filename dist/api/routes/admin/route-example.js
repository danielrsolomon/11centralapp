 ...
 * @access Admin
 */
router.post('/', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateBody)(exampleSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
...
//# sourceMappingURL=route-example.js.map