 ...
 * @access Admin
 */
router.get('/', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
 ...
 * @access Admin
 */
router.get('/:roleId', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateParams)(roleIdSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
 ...
 * @access Admin
 */
router.post('/', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateBody)(roleSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
 ...
 * @access Admin
 */
router.put('/:roleId', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateParams)(roleIdSchema), (0, validation_1.validateBody)(roleSchema.partial()), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
    const { roleId } = req.params;
 ...
 * @access Admin
 */
router.delete('/:roleId', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateParams)(roleIdSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
    const { roleId } = req.params;
    // Check if role exists
    const { data: existingRole, error: checkError } = await supabase_1.supabase
        .from('roles')
...
})), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
    const { roleId } = req.params;
 ...
 * @access Admin
 */
router.post('/assign', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateBody)(userRoleSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
 ...
 * @access Admin
 */
router.delete('/revoke', auth_1.requireAuth, (0, auth_1.requireRole)(['admin']), (0, validation_1.validateBody)(userRoleSchema), (0, express_utils_1.authAsyncHandler)(async (req, res) => {
    const { userId, roleId } = req.body;
