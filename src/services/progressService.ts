...
class ProgressService extends BaseDataService<UserProgress> {
  constructor() {
    super('user_progress');
  }
   ...
   */
  async getUserProgramProgress(userId: string, programId: string): Promise<{
    data: UserProgramProgress | null;
  ...
  async updateModuleProgress(
    userId: string,
    moduleId: string,
    updates: Partial<Omit<UserProgress, 'id' | 'user_id' | 'module_id' | 'created_at' | 'updated_at'>>
  ): Promise<{
    data: UserProgress | null;
    error: PostgrestError | null;
  }> {
   ...
   */
  async completeModule(progressId: string, progressData: Partial<UserProgress>): Promise<{
    data: UserProgress | null;
    error: PostgrestError | null;
  }> {
    try {
   ...
   */
  async calculateProgramProgress(userId: string, programId: string): Promise<{
    data: { completionPercentage: number; isCompleted: boolean } | null;
    error: PostgrestError | null;
  }> {
    try {
   ...
   */
  async getProgressById(progressId: string, userId: string): Promise<{
    data: UserProgress | null;
    error: PostgrestError | null;
  }> {
    try {
   ...
   */
  async createProgress(progressData: Omit<UserProgress, 'id' | 'created_at' | 'updated_at'>): Promise<{
    data: UserProgress | null;
    error: PostgrestError | null;
  }> {
    try {
   ...
   */
  async deleteProgress(progressId: string): Promise<{
    data: UserProgress | null;
    error: PostgrestError | null;
  }> {
    try {
